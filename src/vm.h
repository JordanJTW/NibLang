...
enum {
  ...
  VM_BUILTIN_STRING_SUBSTRING = VM_BUILTIN(4),
  VM_BUILTIN_MAP_NEW = VM_BUILTIN(5),
  VM_BUILTIN_STRING_GET = VM_BUILTIN(6),
  VM_BUILTIN_MAP_SET = VM_BUILTIN(7),
  VM_BUILTIN_STRING_STARTS_WITH = VM_BUILTIN(8),
  ...
  VM_BUILTIN_STRING_VALUE_OF = VM_BUILTIN(18),
  VM_BUILTIN_STRING_HASH = VM_BUILTIN(19),
  VM_BUILTIN_STRING_EQUALS = VM_BUILTIN(20),
};
...
vm_value_t allocate_str_from_c_with_len(const char* str, size_t len);
...
// Allocate a ref-counted object in the heap.
void* vm_gc_allocate(vm_gc_t* gc, size_t size);
