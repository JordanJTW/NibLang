...
vm_value_t vm_string_value_of(vm_value_t* argv, size_t argc, void*);
vm_value_t vm_string_hash(vm_value_t* argv, size_t argc, void*);
vm_value_t vm_string_equals(vm_value_t* argv, size_t argc, void*);