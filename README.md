...
<img src="assets/logo-v2.png?raw=true" width="360px"/>
...
## Code Structure
- The compiler lives in [compiler](compiler/) with the bulk of the pipeline being (in order) [Tokenizer](compiler/parser/tokenizer.cc) => [Parser](compiler/parser/parser.cc) => [SemanticAnalyzer](compiler/expression_checker.cc) & [TypeContext](compiler/type_context.cc) => [BytecodeGenerator](compiler/codegen/bytecode_generator.cc) => [ProgramBuilder](compiler/codegen/program_builder.cc) & [Assembler](compiler/codegen/assembler.cc). All tests are inline within this directory with [compiler/golden_tests.cc](compiler/golden_tests.cc) providing end-to-end integration tests.
